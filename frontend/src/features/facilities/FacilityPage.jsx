...
const FacilityPage = () => {
  ...
  if (isLoading) return <Loader theme="light" text="Loading Facility Details..." />;
  ...
  const heroBg = hero?.backgroundImage || facilityData.image || 'https://images.unsplash.com/photo-1542840410-3092f99611a3?q=80&w=1974&auto=format&fit=crop';
                ...
                {faculty.members.map((member, idx) => (
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 p-5 text-white">
                      <h4 className="font-bold text-lg mb-0.5">{member.name}</h4>
                    ...
                    >
                      ...
                      {img.title && (
                        <div className="absolute bottom-0 inset-x-0 p-5 text-white transform translate-y-2 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                          <p className="font-bold text-base md:text-lg drop-shadow-md line-clamp-1">{img.title}</p>
                        </div>
                      )}
                    </motion.div>
                  );
