...
const InstitutionalResourcesSection = ({ headerData, libraryData, otherResourcesData }) => {
  ...
  return (
    <section id="institutional-resources-section" ref={sectionRef} className="py-8 sm:py-20 w-[98%] max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {otherResourcesData && otherResourcesData.items && otherResourcesData.items.length > 0 && (
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-6 sm:mb-8 w-full">
            <h3 className="text-lg sm:text-[20px] font-semibold text-[#2b2b68] tracking-tight shrink-0">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                            <h4 className="text-white font-semibold text-base sm:text-xl tracking-wide">
                              {displayItem.title}
                            </h4>
                          </div>
                        </div>
