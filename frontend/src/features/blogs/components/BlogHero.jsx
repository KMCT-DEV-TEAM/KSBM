...
const BlogHero = ({ heroData }) => {
  ...
  return (
    <section className="relative w-full min-h-[70vh] sm:min-h-[78vh] md:min-h-[82vh] lg:min-h-[86vh] flex items-center bg-[#1B2155] overflow-hidden pt-28 sm:pt-32 pb-20 md:pb-24">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#1A2155]/95 via-[#212764]/90 to-[#293077]/85"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-[#161B46] via-transparent to-[#161B46]/40"></div>
      </div>
      ...
      <div className="relative z-10 w-[94%] max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-16 my-auto">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight mb-5 sm:mb-7 drop-shadow-md leading-tight">
            {title}
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 font-light leading-relaxed drop-shadow-sm max-w-2xl">
            {subtitle}
          </p>
        </motion.div>
      </div>
