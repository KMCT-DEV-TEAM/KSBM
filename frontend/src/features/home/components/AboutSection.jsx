        ...
        <div className="max-w-[1440px] bg-[#f4fafe] py-10 mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4">
            ...
            <div className="flex flex-col items-center justify-center text-center px-4">
              <span className="text-4xl md:text-5xl font-serif text-[#4e558e] mb-2">16+</span>
              <span className="text-[0.65rem] font-bold tracking-[0.15em] text-gray-600 uppercase">YEARS OF EXCELLENCE</span>
            </div>

            {/* Stat 2 */}
            <div className="flex flex-col items-center justify-center text-center px-4">
              <span className="text-4xl md:text-5xl font-serif text-[#4e558e] mb-2">991+</span>
              <span className="text-[0.65rem] font-bold tracking-[0.15em] text-gray-600 uppercase">ACTIVE STUDENTS</span>
            </div>

            {/* Stat 3 */}
            <div className="flex flex-col items-center justify-center text-center px-4">
              <span className="text-4xl md:text-5xl font-serif text-[#4e558e] mb-2">196+</span>
              <span className="text-[0.65rem] font-bold tracking-[0.15em] text-gray-600 uppercase">GLOBAL RECRUITERS</span>
            </div>
