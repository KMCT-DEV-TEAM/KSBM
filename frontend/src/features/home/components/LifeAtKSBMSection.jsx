    ...
    <section className={`relative w-full bg-[#f4f7f9] py-12 ${lg('lg:py-14')} overflow-hidden`}>
      ...
      {showImages && rawImages.length > 0 && (
        <div className="flex justify-center mt-8">
          <Link
            href="/gallery"
            className="inline-flex items-center gap-2 px-7 py-3 rounded-full border-2 border-primary text-primary text-sm font-semibold tracking-wide hover:bg-primary hover:text-white transition-all duration-300 group"
          >
            View All
            <svg
