  ...
  return (
    <section className="py-20 w-[98%] max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="absolute right-0 top-0 opacity-10 pointer-events-none -z-10 w-64 h-64 bg-[url('/assets/Images/Group%20164.png')] bg-contain bg-no-repeat bg-right-top"></div>
        ...
        <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#454e7d] mb-8">
          Governing Body
        </h2>
