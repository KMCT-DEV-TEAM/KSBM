...
const AdvisoryBoardHero = ({ data }) => {
  const heroBgImage = data?.heroBgImage || '/assets/Images/image 2.png';
  const heroHeading = data?.heroHeading || "Institutional Advisory Board";
  const heroSubtext = data?.heroSubtext || "The Institutional Advisory Board of KMCT School of Business Management plays a crucial role in guiding the institution's strategic vision and academic progress.";
