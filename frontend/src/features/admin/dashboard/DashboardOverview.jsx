      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-[0_2px_6px_0_rgba(67,89,113,0.12)] p-6 relative overflow-hidden flex flex-col justify-center">
          <div className="z-10 w-2/3">
            <h3 className="text-xl font-bold text-[#696CFF] mb-2">Congratulations Admin! 🎉</h3>
            ...
            <button className="text-sm font-semibold text-[#696CFF] bg-[#E7E7FF] px-4 py-2 rounded-md hover:bg-[#696CFF] hover:text-white transition-colors">
              View Badges
            </button>
          </div>
          ...
          <div className="absolute right-0 bottom-0 top-0 w-1/3 opacity-20 pointer-events-none">
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full text-[#696CFF] fill-current">
          ...
          {stats.slice(0, 2).map((stat, idx) => (
            <div key={idx} className="bg-white rounded-xl shadow-[0_2px_6px_0_rgba(67,89,113,0.12)] p-6 flex flex-col justify-between">
              <div className="flex justify-between items-start mb-4">
                ...
                <button className="text-[#697A8D] hover:text-[#696CFF]">
            ...
            <div className="space-y-5">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex gap-4 items-center">
                  <div className="w-10 h-10 rounded-lg bg-[#E7E7FF] text-[#696CFF] flex items-center justify-center shrink-0">
