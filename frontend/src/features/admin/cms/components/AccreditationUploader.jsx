...
const AccreditationUploader = ({ images, setImages, onUploadStateChange, deferredMode = false, onMarkForDeletion = null, maxSize = 1048576 }) => {
          ...
          {isUploading ? (
            ...
            <>
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-2">Maximum 20 images allowed. You can select multiple files. Supports PNG, JPG, WEBP up to {(maxSize || 1048576) >= 1048576 ? `${((maxSize || 1048576) / 1048576).toFixed(1)}MB` : `${((maxSize || 1048576) / 1024).toFixed(0)}KB`}</p>
              </div>
            </>
          )}
        </div>
