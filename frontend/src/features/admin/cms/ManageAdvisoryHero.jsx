...
const ManageAdvisoryHero = () => {
  ...
  return (
    <div className="space-y-6 w-full">
      <PageHeader
        title="Advisory Board Hero & Content"
        description="Manage the Hero section and Content Details of the Advisory Board page."
...
export default ManageAdvisoryHero;
