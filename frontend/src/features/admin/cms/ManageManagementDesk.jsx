...
import { DEFAULT_MANAGEMENT_DESK } from './constants/defaultCmsData';
...
const ManageManagementDesk = () => {
  ...
  const handleResetToDefault = async () => {
    await confirmAction({
      ...
      variant: 'primary',
      action: async () => {
        setShowHero(DEFAULT_MANAGEMENT_DESK.showHero ?? true);
        setShowHeroTextContent(DEFAULT_MANAGEMENT_DESK.showHeroTextContent ?? true);
        setHeroHeading(DEFAULT_MANAGEMENT_DESK.heroHeading || 'Management Desk');
        setHeroSubtext(DEFAULT_MANAGEMENT_DESK.heroSubtext || '');
        setHeroBgImage(DEFAULT_MANAGEMENT_DESK.heroBgImage || '/assets/Images/aboutus/desk_main.png');
        
        setShowIntro(DEFAULT_MANAGEMENT_DESK.showIntro ?? true);
        setIntroSubheading(DEFAULT_MANAGEMENT_DESK.introSubheading || 'MANAGEMENT DESK');
        setIntroHeading(DEFAULT_MANAGEMENT_DESK.introHeading || 'A Vision That Inspires Excellence');
        setIntroDescription(DEFAULT_MANAGEMENT_DESK.introDescription || []);
        
        setShowMembers(DEFAULT_MANAGEMENT_DESK.showMembers ?? true);
        setMembers(DEFAULT_MANAGEMENT_DESK.members || []);
