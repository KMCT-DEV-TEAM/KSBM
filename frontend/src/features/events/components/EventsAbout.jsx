...
const EventsAbout = ({ about }) => {
  ...
  return (
    <section className="relative w-full px-6 md:px-12 lg:px-24 overflow-hidden z-0">
      ...
      <div className="absolute left-[-10%] top-0 -translate-y-[65%] w-64 sm:w-80 md:w-96 lg:w-[32rem] aspect-square z-0 pointer-events-none opacity-80 mix-blend-screen">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        >
          ...
          ></div>
          {/* Subheading */}
          <h5 className="text-xs sm:text-sm md:text-base font-semibold uppercase tracking-[0.2em] mb-1 md:mb-2"
            style={{
          ...
          {/* Heading */}
          <h2 className="text-2xl sm:text-3xl md:text-[40px] font-bold text-white tracking-wide uppercase leading-tight drop-shadow-[0_0_15px_rgba(249,73,180,0.6)] break-words">
            {data.heading || 'THE SPIRIT OF CULTURE'}
          </h2>

          {/* Paragraphs */}
          <div className="text-gray-300 text-sm md:text-[15px] leading-relaxed space-y-4 md:space-y-6 font-medium whitespace-pre-line break-words">
          ...
          {/* Decorative Icon */}
          <div className="hidden sm:block absolute -bottom-8 -right-4 md:-right-8 opacity-40 md:opacity-60 animate-bounce z-[-1]" style={{ animationDuration: '3s' }}>
            <img src="/assets/Images/image 117.png" alt="Decorative Icon" className="w-24 h-24 md:w-40 md:h-40 object-contain" />
          </div>
