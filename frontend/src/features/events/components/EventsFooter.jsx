...
const EventsFooter = ({ previewData, footerGraphic }) => {
  ...
  if (isLoading) {
    return (
      <footer className="relative bg-primary pt-5 pb-8 overflow-hidden animate-pulse">
  ...
  return (
    <footer id="events-footer" className="relative bg-transparent text-white overflow-hidden pb-8 mt-10">
      ...
      <div className="w-full relative z-20 pointer-events-none -mt-4 sm:-mt-8 md:-mt-12 lg:-mt-20">
        <img src={finalFooterGraphic} alt="Events Footer Graphic" className="w-full h-auto object-cover" />
      </div>

      <div className="relative w-[98%] max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 z-10 pt-10">
            ...
            <ul className="flex flex-col gap-5 text-sm text-white/70">
              ...
              {contactInfo?.email && (
                <li className="flex items-center gap-3">
                  ...
                  <a href={`mailto:${contactInfo.email}`} className=" transition-colors">
                    {contactInfo.email}
                  </a>
                </li>
              )}
              {contactInfo?.phone && (
                <li className="flex items-center gap-3">
                  ...
                  <a href={`tel:${contactInfo.phone}`} className=" transition-colors">
                    {contactInfo.phone}
                  </a>
                </li>
              )}
