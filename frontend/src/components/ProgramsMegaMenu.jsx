    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute top-[calc(100%+35px)] left-1/2 -translate-x-1/2 w-[420px] bg-white rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] border border-gray-100 overflow-hidden flex flex-col p-8 z-50"
        >
